...
<%
    ...
    Product p = dao.queryById(id);   // 你需要有 queryById 方法
%>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="mens">
    <div class="main">
        <div class="wrap">
            <ul class="breadcrumb breadcrumb__t"><a class="home" href="index.jsp">首页</a> / <a href="#">太阳镜</a> / 雷朋飞行员经典太阳镜</ul>
            <div class="cont span_2_of_3">
                        ...
                        <div id="products_example">
                            <div id="products">
                                <div class="slides_container">
                                    <img class="a" id="img1" src="<%=p.getPic()%>" alt="<%=p.getpName()%>" />
                                </div>
                                <ul class="pagination">
                ...
                <div class="desc1 span_3_of_2">
                    <h3 class="m_3"><%=p.getpName()%></h3>
                    <p class="m_5">
                        ¥<%=p.getPrice()%>
                        <% if(p.getSale() > 0) { %>
                        <span class="reducedfrom">¥<%=p.getPrice() + p.getSale()%></span>
                        <a href="#">限时优惠</a>
                        <% } %>
                    </p>
                    <div class="btn_form">
                    ...
                    <span class="m_link"><a href="#">登陆后收藏</a> </span>
                    <p class="m_text2">
                        <%= p.getIntro() %>
                    </p>
                </div>
                ...
                <div class="toogle">
                    ...
                    <p class="m_text">
                        ...
                        【适合脸型】多种脸型适用<br>
                        <br>
                        雷朋飞行员系列，1937年诞生至今，始终是时尚与经典的代名词。
                        精选优质材料，精湛工艺打造，为您提供卓越的佩戴体验。
                    </p>
                </div>
                <div class="toogle">
                    <h3 class="m_3">购买须知</h3>
                    <p class="m_text">
                        【正品保证】本店所售商品均为正品，支持专柜验货<br>
                        【退换政策】7天无理由退换，商品完好即可<br>
                        【配送说明】全国包邮，偏远地区除外<br>
                        【售后服务】提供一年质保，终身维护<br>
                        【温馨提示】请避免长时间暴晒和高温环境，建议使用专用眼镜布擦拭
                    </p>
                </div>
            </div>
