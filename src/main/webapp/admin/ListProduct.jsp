...
<form method="post" action="AdminProductServlet" id="listform">
    <div class="panel admin-panel">
        ...
        %>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<%=product.getId()%>" />
                        <%=product.getId()%></td>
                    <td><%=product.getpName()%></td>
                    <td width="10%"><img src="<%=product.getPic()%>" alt="" width="70" height="50" /></td>
