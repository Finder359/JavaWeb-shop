...
<body>
<form method="post" action="AdminFrontUserServlet" id="listform">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            <%
                ArrayList<FrontUser> list = (ArrayList<FrontUser>) request.getAttribute("frontUsers");
            ...
            <volist name="list" id="vo">
                <tr>
                    <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<%=u.getId()%>" />
                        <%=u.getId()%></td>
                    <td><%=u.getUsername()%></td>
                    <td><%=u.getRealName()%></td>
                    <td><%=u.getSex()%></td>
